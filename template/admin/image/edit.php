...
<?php  foreach($this->wf->languages as $v){
    ...
    ?>
    <div class="content_edit content_edit_<?php WRA::e($v->alias); ?>" 
    	<?php if ($v->alias != wra_lang::getdefault()) WRA::e("style=display:none;"); ?> >
    ...
    <tr>
		...
		switch($ac->editstatus){
			...
			case admincolumntype::images:
				// WRA::debug($ac);
				// WRA::debug($tdcontent);
				// if($v->alias == wra_lang::getdefault()){
                    ?>
					<div class="linkadd bal linkadd_<?php WRA::e($v->alias);?>" target="table_<?php WRA::e($curid);?>_<?php WRA::e($v->alias);?>" id="linkadd_<?php WRA::e($v->alias);?>_<?php WRA::e($curid);?>" <?php if ($v->alias != wra_lang::getdefault()) WRA::e("style=display:none;"); ?> >Добавить фотографию</div>
                    <div class="linkaddempty bal" target="table_<?php WRA::e($curid);?>_<?php WRA::e($v->alias);?>" id="linkaddempty_<?php WRA::e($v->alias);?>_<?php WRA::e($curid);?>"<?php if ($v->alias != wra_lang::getdefault()) WRA::e("style=display:none;"); ?> >Добавить строку</div>
                    <div class="linktable bal" target="table_<?php WRA::e($curid);?>_<?php WRA::e($v->alias);?>" id="linktabl_<?php WRA::e($v->alias);?>_<?php WRA::e($curid);?>"<?php if ($v->alias != wra_lang::getdefault()) WRA::e("style=display:none;"); ?> >Плиткой</div>
                    <br/><br/>
                <?php //}?>
				<div id="table_<?php WRA::e($curid);?>_<?php WRA::e($v->alias);?>" class="imgstable" style="width:100%">
					<?php
					// WRA::debug($ac->);
					// empty pic line
					...
					<div class="row new empty-img-pattern" id="infopic-new-00" style="display:none;">
						...
						<div class="imginfo">
                            ...
                            <div><span>Название:</span><input type="text" name="<?php WRA::e($curid);?>_header_<?php WRA::e($v->alias);?>_old" id="<?php WRA::e($curid);?>_header_<?php WRA::e($v->alias);?>_old" class="<?php WRA::e($curid);?>_header" value=""/>     
                                <input type="hidden" class="path00" name="<?php WRA::e($curid);?>_path_<?php WRA::e($v->alias);?>_old" id="<?php WRA::e($curid);?>_path_<?php WRA::e($v->alias);?>_old" value=""/></div>
                            <div><span>Ссылка</span><textarea  name="<?php WRA::e($curid);?>_link_<?php WRA::e($v->alias);?>_old" id="<?php WRA::e($curid);?>_link_<?php WRA::e($v->alias);?>_old" class="<?php WRA::e($curid);?>_link"></textarea></div>
                            <div><span>Описание</span><textarea  name="<?php WRA::e($curid);?>_description_<?php WRA::e($v->alias);?>_old" id="<?php WRA::e($curid);?>_description_<?php WRA::e($v->alias);?>_old" class="<?php WRA::e($curid);?>_description"></textarea></div>
                            <div><span>Порядок сортировки</span><input type="text" style="width:50px" name="<?php WRA::e($curid);?>_sortorder_<?php WRA::e($v->alias);?>_old" id="<?php WRA::e($curid);?>_sortorder_<?php WRA::e($v->alias);?>_old" class="<?php WRA::e($curid);?>_sortorder" value=""/></div>
                            <div><span>Рамка</span><input type="checkbox"  name="<?php WRA::e($curid);?>_morevisual_<?php WRA::e($v->alias);?>_old" id="<?php WRA::e($curid);?>_morevisual_<?php WRA::e($v->alias);?>_old" class="<?php WRA::e($curid);?>_morevisual" value="1"/></div>
                            <div><span>HTML</span><textarea placeholder="HTML"  name="<?php WRA::e($curid);?>_htmlcontent_<?php WRA::e($v->alias);?>_old" id="<?php WRA::e($curid);?>_htmlcontent_<?php WRA::e($v->alias);?>_old"  class="<?php WRA::e($curid);?>_htmlcontent"></textarea></div>
                        </div>
						<div class="imginfo">
					...
					// WRA::debug($ac->items);
					// WRA::debug($ac->lang);
					if (empty($ac->items[$v->alias])) {$ac->items[$v->alias] = array();}
					foreach ($ac->items[$v->alias] as $w0) {
						// WRA::debug($w0);
						?>
                        <div class="row old" id="infopic-old-<?WRA::e($w0->id);?>-<?WRA::e($v->alias);?>">
							<div><img src="<?= WRA::base_url() ?><?WRA::e($w0->tmbpic);?>" width="120px"/></div>
							<div class="imginfo">
                                 <div><span>Id:</span><span class="id00" ><?php WRA::e($w0->id);?></span></div>
                                <div><span>Название:</span><input type="text" name="<?php WRA::e($curid);?>_header_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" id="<?php WRA::e($curid);?>_header_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" class="<?php WRA::e($curid);?>_header" value="<?php WRA::e($w0->header);?>"/>     
                                    <input type="hidden" class="path00" name="<?php WRA::e($curid);?>_path_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" id="<?php WRA::e($curid);?>_path_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" value="<?php WRA::e($w0->header);?>"/></div>
                                <div><span>Ссылка</span><textarea  name="<?php WRA::e($curid);?>_link_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" id="<?php WRA::e($curid);?>_link_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" class="<?php WRA::e($curid);?>_link"><?php WRA::e($w0->link);?></textarea></div>
                                <div><span>Описание</span><textarea  name="<?php WRA::e($curid);?>_description_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" id="<?php WRA::e($curid);?>_description_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" class="<?php WRA::e($curid);?>_description"><?php WRA::e($w0->description);?></textarea></div>
                                <div><span>Порядок сортировки</span><input type="text" style="width:50px" name="<?php WRA::e($curid);?>_sortorder_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" id="<?php WRA::e($curid);?>_sortorder_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" class="<?php WRA::e($curid);?>_sortorder" value="<?php WRA::e($w0->sortorder);?>"/></div>
                                <div><span>Рамка</span><input type="checkbox"  name="<?php WRA::e($curid);?>_morevisual_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" id="<?php WRA::e($curid);?>_morevisual_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" class="<?php WRA::e($curid);?>_morevisual" value="1" <?php if($w0->morevisual==1){?>checked="checked"<? }?>/></div>
                                <div><span>HTML</span><textarea placeholder="HTML"  name="<?php WRA::e($curid);?>_htmlcontent_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>" id="<?php WRA::e($curid);?>_htmlcontent_<?php WRA::e($v->alias);?>_<?WRA::e($w0->id);?>"  class="<?php WRA::e($curid);?>_htmlcontent"><?php WRA::e($w0->htmlcontent);?></textarea></div>
                            </div>
							<div class="imginfo">
								<a href="#" class="deleteinfoimage">удалить</a>
							</div>
